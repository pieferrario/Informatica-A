/*Definire una funzione FirstEven che, data una ListaDiInteri restituisce la posizione (puntatore) del primo elemento pari nella lista 
...
int main() {
    ...
    ListaDiElem ris1=FirstEven(lista1);
    printf("Il primo pari di lista 1 e: %d", ris1->info);
    ListaDiElem ris2=FirstEven(lista2);
    printf("Il primo pari di lista 2 e: %d", ris2->info);
//    
